        ...
        <div className="body">
            <div className="filter">
                <div className="searchSection">
                    <input type="text" className="searchBar" placeholder="Search by name..." value={searchValueName} onChange={changeSearchValueName} />
                    <button className="searchButton" style={{ backgroundColor: "black", color: "yellow", cursor: "pointer" }} onClick={filterByName}>Search</button>
                </div>
                <button className="filter-btn" onClick={filteredTopData}>Top Rated Restaurant</button>
                <div className="searchSection">
                    <input type="text" className="searchBar" placeholder="Search by price..." value={searchValue} onChange={changeSearchValue} />
                    <button className="searchButton" style={{ backgroundColor: "black", color: "yellow", cursor: "pointer" }} onClick={filterByPrice}>Search</button>
                </div>
            </div>
